...
-- Schema gym_tracker
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `gym_tracker` DEFAULT CHARACTER SET utf8mb3 ;
USE `gym_tracker` ;
...
CREATE TABLE IF NOT EXISTS `gym_tracker`.`personal_weight` (
  ...
  INDEX `fk_personal_weight_user1_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_personal_weight_user1`
    FOREIGN KEY (`user_id`)
